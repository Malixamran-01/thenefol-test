...
export async function ensureCollabBlockSchema(pool: Pool): Promise<void> {
  await pool.query(`
    CREATE TABLE IF NOT EXISTS collab_program_blocks (
      ...
      public_message TEXT NOT NULL DEFAULT 'Your access to the Creator Collab program has been restricted. If you believe this is a mistake, you can submit an appeal below.',
