...
class UserSocketService {
  ...
  connect(userId?: string) {
    ...
    // Use environment variables for socket connection
    const socketHost = (import.meta.env.VITE_BACKEND_HOST as string) || (import.meta.env.VITE_API_HOST as string) || window.location.hostname
